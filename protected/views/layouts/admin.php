            ...
            <div class="left-side col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light shadow">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-0 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start col-12" id="menu">
                        <li class="nav-item">
                            <a href="<?= $this->createAbsoluteUrl('/admin/index') ?>" class="nav-link text-dark align-middle px-3">
                                <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->createAbsoluteUrl('/admin/class', ['page_no' => 1]) ?>" class="nav-link text-dark px-3 align-middle">
                                <i class="h3 bi bi-easel2"></i> <span class="ms-1 d-none d-sm-inline">Classrooms</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->createAbsoluteUrl('/admin/users', ['page_no' => 1]) ?>" class="nav-link text-dark px-3 align-middle">
                                <i class="h3 bi bi-people"></i> <span class="ms-1 d-none d-sm-inline">Users</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->createAbsoluteUrl('/home/createclass') ?>" class="nav-link text-dark px-3 align-middle">
                                <i class="h3 bi bi-plus-lg"></i> <span class="ms-1 d-none d-sm-inline">Create Class</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->createAbsoluteUrl('/admin/viewevent', ['page_no' => 1]) ?>" class="nav-link text-dark px-3 align-middle">
