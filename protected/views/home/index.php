...
<div class="p-4">
    <p class="display-6" style="font-size: 28px !important;">Your Classrooms</p>
            ...
            <div class="card">
                <div class="bg-0 py-3">
                    <div class="m-3 d-flex justify-content-between">
                        <div>
                            <p class="h4 text-light">Course Title</p>
                            <ul>
                                <li class="text-light">Code : Resct-98108</li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-white text-small shadow">
                                <li><a class="dropdown-item" href="/index.php/user/profile">Delete</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-success">Open Classroom</a>
                </div>
            </div>
        </div>
    </div>
