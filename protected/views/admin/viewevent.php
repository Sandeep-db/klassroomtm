...
<div class="modal fade" id="add-event" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <?php echo CHtml::hiddenField('course_code', 'course-0000'); ?>
...
<div class="p-4">
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex">
            <div>
                <a class="btn btn-success mx-1" href="<?= Yii::app()->createAbsoluteUrl('admin/viewevent', ['page_no' => $pre_page]) ?>">⥢</a>
                <a class="btn btn-outline-dark mx-1"><?= $page_no ?></a>
                <a class="btn btn-success mx-1" href="<?= Yii::app()->createAbsoluteUrl('admin/viewevent', ['page_no' => $nxt_page]) ?>">⥤</a>
            </div>
        ...
        <?php
            ...
            foreach ($events as $key => $event) {
                if ($event['source'] == 's3-bucket') {
                    ...
                    <h1 class="display-6 text-center mt-2 mb-5" style="font-size: 25px">{$event['name']}</h1>
                    EOL;
                } else {
                    echo <<< EOL
                    <div class="d-flex justify-content-center mt-3">
                    ...
                    <h1 class="display-6 text-center mt-2 mb-b" style="font-size: 25px">{$event['name']}</h1>
                    EOL;
                    $var_div .= <<< EOL
